...
import { getRelationListRequest, getSearchBoarListRequest } from 'apis';
...
export default function Search() {
  ...
  const getSearchBoarListResponse = (responseBody: GetSearchBoardListResponseDto | ResponseDto | null) => {
  ...
  useEffect(() => {
    if (!searchWord) return;
    getSearchBoarListRequest(searchWord, preSearchWord).then(getSearchBoarListResponse);
